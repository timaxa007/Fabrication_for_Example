...
public class FabricationGuiContainer extends GuiContainer {
	...
	private static final ResourceLocation texture = new ResourceLocation("fabrication", "textures/gui/lesson2b.png");
	...
	public void drawGuiContainerBackgroundLayer(float parTick, int mouseX, int mouseY) {
		...
		if (tile_entity.time_max > 0) {
			this.drawTexturedModalRect(this.guiLeft + 78, this.guiTop + 33, 176, 0, 22 - (int)((float)(tile_entity.time / (float)tile_entity.time_max) * 22F), 17);
		}
	}
